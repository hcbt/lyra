...
def download():
    ...
    for genre in genres:
        pathlib.Path(f"data/{genre}").mkdir(parents=True, exist_ok=True)
    
    print("downloading house dataset")
    utils.download_playlists.download("https://www.youtube.com/playlist?list=PLS9qGVIfZRpzFAyUAz0oh0X7XsDO6i1C0", "data/house")# House playlist
    ...
    utils.download_playlists.download("https://www.youtube.com/playlist?list=PLS9qGVIfZRpz5UMjAWwCdhHaJNT6V2Jna", "data/techno")# Techno playlist
